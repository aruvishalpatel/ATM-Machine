...
public class TransactionManagement {
	...
	public void managementTransaction(String Required, String account_number, String password) throws Exception {
		...
		for (int i = 0; i < 4; i++) {
			String query1 = "select note_of_" + typeNote[i] + " from atm_machine_balance where id=1";
		...
		if (moneyRequired != 0) {
			...
			if (checkMoney > saving_balance && checkMoney < atmMoney) {
				...
				if (isValidCondition) {
					switch (choice1) {
					case 1: {
						System.out.println("Total Available balance in your Account is = " + saving_balance);
						System.out.println(
								"\n\n\n#####################################: Thank you for using this ATM Machine :##################################### \n\n");
						break;
					}
				...
				if (isValid) {
					...
					case 1: {
						...
						System.out.println("Total Available balance in ATM is = " + atmMoney);
						System.out.println(
								"\n\n\n#####################################: Thank you for using this ATM Machine :##################################### ");
			...
			String text1 = "Dear User, ur A/c: " + account_number + "-debited Rs" + massageMoney + " on " + date_time
			...
			if (result) {
				...
				System.out.println("Total Amount is = " + tatalAmount);
				System.out.println("Remaining Amount in your Account is : " + updateBalance);
				System.out.println(
						"\n\n\n#####################################: Thank you for using this ATM Machine :##################################### ");
